// ! t extends Animal maens T can be Animal or its child class
...
this.animal = animal;
  ...
  AnimalHelper<Animal> animalHepler1 = new AnimalHelper<>();
animalHepler1.setAnimal(new Bird());
animalHepler1.setAnimal(new Dog("John"));
